...
imagen_path = 'assets/anime.jpg'
imagen = cv2.imread(imagen_path)

imagen_rgb = cv2.cvtColor(imagen, cv2.COLOR_BGR2RGB)
imagen_rgb = cv2.resize(imagen_rgb, (ancho, alto))
cv2.putText(imagen_rgb, 'RGB', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
...
cv2.putText(imagen_cmyk, 'CMYK', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)

imagen_lab = cv2.cvtColor(imagen, cv2.COLOR_BGR2LAB)
imagen_lab = cv2.resize(imagen_lab, (ancho, alto))
cv2.putText(imagen_lab, 'LAB', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)

imagen_luv = cv2.cvtColor(imagen, cv2.COLOR_BGR2LUV)
imagen_luv = cv2.resize(imagen_luv, (ancho, alto))
cv2.putText(imagen_luv, 'LUV', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)

imagen_hsv = cv2.cvtColor(imagen, cv2.COLOR_BGR2HSV)
imagen_hsv = cv2.resize(imagen_hsv, (ancho, alto))
cv2.putText(imagen_hsv, 'HSV', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)

imagen_hsl = cv2.cvtColor(imagen, cv2.COLOR_BGR2HLS)
imagen_hsl = cv2.resize(imagen_hsl, (ancho, alto))
cv2.putText(imagen_hsl, 'HSL', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
...
cv2.putText(imagen_rgb_espectral, 'Espacio Espectral', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)

# Concatenar todas las imágenes en un solo eje
